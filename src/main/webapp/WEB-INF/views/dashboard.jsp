	...
	<div id="wrapper">
		...
		<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" onclick="ajaxGet('/springbank/home/')"
					href="javascript:;">Spring Bank</a>
			</div>
			<!-- Top Menu Items -->
			<ul class="nav navbar-right top-nav">
				<li class="dropdown"><a href="#" class="dropdown-toggle"
					data-toggle="dropdown"><i class="fa fa-user"></i>
						${usuarioNome} <b class="caret"></b></a>
					<ul class="dropdown-menu">
						<li><a
							href="<?php echo $base_url?>usuario/editar/<?php echo $usuarioId;?>"><i
			...
			<div class="collapse navbar-collapse navbar-ex1-collapse">
				<ul class="nav navbar-nav side-nav">
					<li><a href="javascript:;"
						onclick="ajaxGet('/springbank/transacao/')"> <i
							class="glyphicon glyphicon-usd"></i> Transações
					</a></li>
					<li><a href="javascript:;"
						onclick="ajaxGet('/springbank/conta/')"><i
							class="fa fa-fw fa-bar-chart-o"></i> Contas</a></li>
					<li><a href="javascript:;" data-toggle="collapse"
						data-target="#demo"><i class="fa fa-fw fa-wrench"></i>
							Cadastros <i class="fa fa-fw fa-caret-down"></i></a>
						<ul id="demo" class="collapse">
							<li><a href="javascript:;"
								onclick="ajaxGet('/springbank/agencia/')">Agencias</a></li>
							<li><a href="javascript:;"
								onclick="ajaxGet('/springbank/cliente/')">Clientes</a></li>
							<li><a href="javascript:;"
								onclick="ajaxGet('/springbank/gerente/')">Gerentes</a></li>
							<li><a href="javascript:;"
								onclick="ajaxGet('/springbank/usuario/')">Usuários</a></li>
						</ul></li>
				</ul>
			</div>
			<!-- /.navbar-collapse -->
