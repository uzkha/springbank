...
<div id="container-large">
	<ul class="nav nav-tabs">
		...
		<li role="presentation"><a onclick="ajaxGet('/springbank/gerente/editar/${gerente.id}')"
			href="javascript:;">Gerente</a></li>
		<li role="presentation" class="active"><a onclick="ajaxGet('/springbank/gerente/usuario/${gerente.id}')"
				...
				<div class="form-group">
					<div class="col-sm-offset-2 col-sm-10">
						<button type="button" value="button.back" class="btn btn-default"
							onclick="ajaxGet('/springbank/gerente/editar/${gerente.id}')">Cancelar</button>
